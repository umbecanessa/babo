...
_TURN_TRIAGE_SYSTEM_BASE = (
    ...
    "  explore:parallel_reads — user wants to study/analyze/explore a repo, "
    "codebase, or many files. Emit when bulk reading is likely; agent should "
    "use glob/list_dir then batch parallel read() calls per turn.\n"
