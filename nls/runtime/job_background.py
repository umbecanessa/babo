...
def build_job_background_wake_prompt(
    ...
    *,
    ...
    lines.append(
        ...
        "When you finish a bug investigation or idle todo, post a concise mobile-friendly "
        "summary to the originating coordination channel (tag the reporter when known). "
        "The runtime also delivers your final summary automatically when possible.\n"
