...
meta = SkillMeta(
    ...
    onboarding=SkillOnboarding(
        ...
        setup_prompt=(
            ...
            "5. channel_history = ambient log (messages since bot joined). "
            "channel_remote read = pre-connect backfill on Discord/Slack only. "
            "Use channel_remote send/delete and channel_manage for admin — "
