        ...
        behavioral_defs: list[dict[str, str]] = [
            ...
            },
            {
                ...
                "content": (
                    ...
                    "When a channel integration is configured, prefer channel_manage "
                    "for server admin over raw curl to vendor REST APIs (tokens stay scoped).\n"
                    ...
                    "for bot tokens or channel names. When configured + live, use "
                    "channel_manage for admin — not raw vendor API scripts.\n"
            ...
            },
            {
                ...
                "content": (
                    ...
                    "Example only — replace with the USER's project title/dir:\n"
