...
1. **[Production architecture & onboarding](production-architecture-and-onboarding.md)** — ship-ready map + wizard UX.
2. **[Deployment topologies](deployment-topologies.md)** — desktop hub, hosted web, NestJS relay.
3. **[System overview](overview.md)** — repository map and request path.
4. **[Data flow](data-flow.md)** — messages, signals, sleep.
