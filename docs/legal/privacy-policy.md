...
| **Operator** | Babo Agency — optional hosted Babo Cloud control plane (contact below) |
...
| **Babo Cloud inference proxy** | Hosted models | Same, routed through our hosted control plane when you use that option |
